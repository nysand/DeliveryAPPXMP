...
namespace DeliveryApp.Droid
{
    ...
    public class TabsActivity : Android.Support.V4.App.FragmentActivity
    {
        ...
        void TabsToolbar_MenuItemClick(object sender, Android.Support.V7.Widget.Toolbar.MenuItemClickEventArgs e)
        {
            if(e.Item.ItemId == Resource.Id.action_add)
            {
                StartActivity(typeof(SharePlaceActivity));
            }
        }
        ...
        private void TabLayout_TabSelected(object sender, TabLayout.TabSelectedEventArgs e)
        {
            switch (e.Tab.Position)
            {
                case 0:
                    ...
                    break;
                case 1:
                    FragmentNavigate(new Delivered());
                    break;
                case 2:
